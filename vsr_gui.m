function varargout = vsr_gui(varargin)
% VSR_GUI MATLAB code for vsr_gui.fig
%      VSR_GUI, by itself, creates a new VSR_GUI or raises the existing
%      singleton*.
%
%      H = VSR_GUI returns the handle to a new VSR_GUI or the handle to
%      the existing singleton*.
%
%      VSR_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VSR_GUI.M with the given input arguments.
%
%      VSR_GUI('Property','Value',...) creates a new VSR_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vsr_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vsr_gui_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 14-May-2016 11:05:50

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vsr_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @vsr_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function vsr_gui_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = vsr_gui_OutputFcn(hObject, eventdata, handles) 
